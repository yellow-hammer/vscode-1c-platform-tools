...
| **xUnit / Vanessa-ADD** | исходники тестовых обработок → методы                     | `vrunner xunit <.epf>` (обработка собирается автоматически)      | jUnit из активного профиля (секция xunit, `reportsxunit`) |
