...
Панель показывает свойства того, что выделено, группами - как палитра свойств конфигуратора: сверху поиск по свойствам и переключатель «А-Я» (список без групп, по алфавиту), внизу пояснение к выбранной строке, в заголовке имя выделенного. Панель можно перетащить куда удобно, в том числе в правую боковую, - тогда форма и свойства видны одновременно.
