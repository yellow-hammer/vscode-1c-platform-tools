...
Изменения копятся в панели и уходят в файлы одним нажатием **Сохранить**. Заимствованные объекты расширений (`ObjectBelonging = Adopted`) открываются только на просмотр: у них свои правила состава XML. В дереве такие объекты помечаются значком **«З»** на пиктограмме.
