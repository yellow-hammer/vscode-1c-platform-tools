...
Изменения копятся в панели и уходят в файлы одним нажатием **Сохранить**. Заимствованные объекты расширений открываются только на просмотр: у них свои правила состава XML. В дереве они помечены значком **З** на пиктограмме.
