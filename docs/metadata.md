...
Клик по форме в дереве метаданных открывает её вкладкой: дерево элементов, схематичное превью, данные формы (реквизиты, команды, параметры, обработчики) и свойства выделенного элемента.
