...
Принудительно переустановить компоненты — команда **Обновить внешние компоненты** в разделе **Зависимости** дерева **Инструменты 1С**. Выбранные в списке компоненты загружаются заново сразу.
