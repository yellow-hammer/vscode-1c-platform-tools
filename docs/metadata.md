...
Клик по форме в дереве метаданных открывает её вкладкой: дерево элементов, схематичное превью и данные формы (реквизиты, команды, параметры, обработчики). Свойства выделенного элемента показывает панель **«Свойства 1С»** - при открытии формы она разворачивается сама.
...
Выделение синхронно в дереве и на превью. Клик по обработчику события открывает модуль формы на нужной процедуре. Флажок **«Служебные элементы»** добавляет в дерево и превью расширенные подсказки и контекстные меню.

## Свойства выделенного

Свойства живут в отдельной панели **«Свойства 1С»** со своим значком на панели действий. Она показывает свойства того, что выделено, группами - как палитра свойств конфигуратора, а в заголовке видно имя выделенного. Панель можно перетащить куда удобно, в том числе в правую боковую панель, - тогда форма и свойства видны одновременно.
