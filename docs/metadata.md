...
Команда **«1С: Метаданные: Показать в дереве метаданных»** (Ctrl+Alt+T) находит в дереве объект, которому принадлежит открытый файл, и выделяет его. Она же лежит в контекстном меню редактора, вкладки и проводника.
