...
const guides = [
	{ text: 'Инструменты 1С', link: '/tools' },
	{ text: 'Проекты 1С', link: '/projects' },
	{ text: 'Администрирование 1С', link: '/admin' },
	{ text: 'Артефакты 1С', link: '/artifacts' },
	{ text: 'Метаданные 1С', link: '/metadata' },
