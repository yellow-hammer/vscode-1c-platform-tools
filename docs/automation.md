...
- Из палитры: **1С: Пайплайны: Запустить пайплайн** со списком цепочек.
...
Файл создаётся сам при первом открытии редактора. Он также входит в [служебные файлы](service-files.md): раздел **Служебные файлы** → **1cpt: hooks**, либо палитра «1С: Служебные файлы: Создать служебные файлы…».
