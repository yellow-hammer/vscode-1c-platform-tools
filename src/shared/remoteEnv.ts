 ...
 *
 * Два отличия, которые видит пользователь: локальный адрес нужно пробрасывать
 * наружу, а графической оболочки 1С в контейнере нет.
 *
 * @module remoteEnv
 */
 ...
 *
 * Команду не прячем и не запрещаем: удалённые окружения бывают и с рабочим
 * графическим выводом.
 *
