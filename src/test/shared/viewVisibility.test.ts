 ...
 * по состоянию отладки, а панель «Администрирование 1С» к рабочей области не привязана:
...
const ALWAYS_AVAILABLE = new Map<string, string>([
	...
	['1c-platform-tools-infobases', 'список информационных баз платформы не зависит от рабочей области'],
