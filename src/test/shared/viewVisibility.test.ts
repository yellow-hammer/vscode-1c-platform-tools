 ...
 *
 * Панель проектов - единственное место, откуда проект открывают, Debug targets живут
 * по состоянию отладки, а консоль кластера к рабочей области не привязана вовсе:
 * кластером управляют и без исходников конфигурации под рукой.
 */
const ALWAYS_AVAILABLE = new Map<string, string>([
	...
	['1c-platform-tools-clusters-tree', 'администрирование кластера не зависит от рабочей области'],
	['1c-platform-tools-clusters-help', 'администрирование кластера не зависит от рабочей области'],
