...
export const TREE_GROUPS: TreeGroup[] = [
	...
	},
	{
		...
		commands: [
			...
			{ command: '1c-platform-tools.epf.compileReport', title: getBuildExternalReportCommandName().title, treeLabel: '🔨 Собрать внешний отчёт' },
			...
			{ command: '1c-platform-tools.epf.decompileReport', title: getDecompileExternalReportCommandName().title, treeLabel: '🔓 Разобрать внешний отчёт' },
