...
export interface TestFrameworkAdapter {
	 ...
	 *
	 * Адаптеры, которым нужна раскладка проекта, отдают их промисом: каталоги
	 * конфигурации и расширений в формате EDT известны только после обхода.
	 */
	getIncludeGlobs(): string[] | Promise<string[]>;
