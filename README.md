...
Во время сессии отладки доступен замер производительности — кнопка на панели отладки или команды **1C: Отладка: Начать/Закончить замер производительности**. По завершении замера открывается таблица результатов (модуль, строка, код, число выполнений, время, доля от общего) с сортировкой, фильтром и переходом к строке по двойному клику; в самих модулях время отображается колонкой слева от кода.
