...
- **[Инструменты 1С](docs/tools.md)** — дерево команд: информационная база, конфигурация, расширения, внешние файлы, поставка, запуск, тестовое окружение и тестирование, зависимости, выбор установки OneScript.
...
- **[Список дел 1С](docs/todo.md)** — панель меток TODO/FIXME/XXX/HACK/BUG в коде проекта.
