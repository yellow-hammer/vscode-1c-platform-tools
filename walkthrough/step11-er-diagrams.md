...
Откройте диаграмму через кнопку на панели **«1С: Метаданные»** (значок ER) или через контекстное меню любого объекта метаданных — откроется конструктор с выбранным объектом и его прямыми связями.
